...
import { r as RANGE_IDS, t as DEFAULT_SYMBOLS } from "./market-types-gv-rWKG5.mjs";
import { r as TriangleAlert } from "../_libs/lucide-react.mjs";
import { n as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as Provider } from "../_libs/radix-ui__react-tooltip.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CF5-snuD.js
...
var styles_default = "/assets/styles-BVfZvPoX.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Список наблюдения и графики котировок в духе Google Финансы."
			},
			{
				name: "theme-color",
				content: "#f4f3ee"
...
var getQuotes = createServerFn({ method: "POST" }).validator(object({ symbols: array(string()).min(1).max(40) })).handler(createSsrRpc("fbac33f52a0daa5a2a65572f2d89ee0bcd8d773e8633a0c2922c53cb0bdbdd74"));
...
var searchSymbols = createServerFn({ method: "POST" }).validator(object({ q: string().min(1).max(80) })).handler(createSsrRpc("6526d28b5af5f698b2c7b1aadfdfd5ec325fff6f69da3f7dc653990e6804737e"));
...
var $$splitComponentImporter = () => import("./routes-BK5EM0aB.mjs");
